...
const Sec12 = () => {
    return (
        <section className='flex flex-col gap-6 '>
            ...
            <iframe className='w-full aspect-video rounded-[12px]' src="https://www.youtube.com/embed/YRTe_sJd_2A?si=DDufqFWp-Vjp6wrJ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </section>
    )
}
