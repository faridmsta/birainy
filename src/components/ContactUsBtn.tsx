...
const ContactUsBtn = () => {
    return (
        <Link
            className="bg-primary rounded-[8px] inline-block py-[10px] px-[24px] vs:py-[12px] vs:px-[40px]"
            href={''}>
            <button className="flex items-center gap-3">
                <PhoneIcon />
                <span className="font-grotesk text-[0.875rem] vs:text-[1rem]">Bizimlə əlaqə saxlayın</span>
            </button>
        </Link>
    )
}
